...
<body>
    <header>
        ...
        <div class="inline-header-container-right">
            <div class="header-link">Wróć do strony głównej</div>
        </div>
    </header>
    <nav>
        <ul>
