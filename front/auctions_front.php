        ...
        <aside>
            ...
            <div id="filter-form-container">
                <form method="post" action="">
                    ...
                    <p>Stan:</p>
                    <input type="checkbox" name="new-checkbox" <?php if(isset($_POST['new-checkbox'])){echo "checked";} ?>/> Nowy<br>
                    <input type="checkbox" name="used-checkbox" <?php if(isset($_POST['used-checkbox'])){echo "checked";} ?> /> Używany<br>
                    <p>Rok produkcji:</p>
                    <input type="number" name="production-year" min="0" max="2022" <?php if(isset($_POST['production-year'])){echo "value='".$_POST['production-year']."'";}?>/><br>
                    <p>Cena:</p>
